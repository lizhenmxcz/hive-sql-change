...
public class HivePrivilegeObject implements Comparable<HivePrivilegeObject> {
  ...
  private String limitFilterExpression;
  ...
  public String getLimitFilterExpression() {
    return limitFilterExpression;
  }

  public void setLimitFilterExpression(String limitFilterExpression) {
    this.limitFilterExpression = limitFilterExpression;
  }
}
